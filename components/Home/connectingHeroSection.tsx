// ConnectingHeroSection.tsx
// Font: add `@fontsource/bebas-neue` to your project → `npm i @fontsource/bebas-neue`
// Then import it once in your root layout: import "@fontsource/bebas-neue";

import Image from "next/image";
import { ArrowRight } from "lucide-react";
import { cn } from "@/lib/utils";
// import { MaskedReveal } from "@/components/ui/masked-reveal";
// import { EditorialRuleCta } from "@/components/ui/editorial-rule-cta";
import {
  campaignUrbanBodega,
  campaignMotionFocus,
  service,
...
// ConnectingHeroSection.tsx
// Requires: npm i @fontsource/bebas-neue
// Import once in app/layout.tsx → import "@fontsource/bebas-neue";
...
// ─── photo collage ────────────────────────────────────────────────────────────
//
// Three photos scattered like physical prints:
//   ph1 → portrait  (3:4)  bottom-left,  –5 °
//   ph2 → square    (1:1)  top-right,    +7 °
//   ph3 → motion    (4:5)  center,       –10°
//
// All share a thick white border (photo-print feel) and a soft drop shadow.
// Each animates in independently via CSS keyframes.

const PRINT_BORDER = "5px solid #fff";
const PHOTO_SHADOW =
      ...
      <div className={PAGE}>
        ...
        <div className="hidden lg:block">
          ...
          <div className="flex items-center justify-between gap-8">
            ...
            {/* collage — not wrapped in MaskedReveal; per-photo keyframes handle entry */}
            <PhotoCollage
              containerW={288}
              containerH={348}
              p1W={140}
...
// const headlineDesktop: React.CSSProperties = {
//   ...DISPLAY_FONT,
//   fontSize: "clamp(64px, 7.8vw, 88px)",
//   lineHeight: 0.91,
// };
//
// const ORANGE = "#FF6B00";
// const ORANGE_CLS = "text-[#FF6B00]";
// const MUTED_CLS = "text-neutral-600 dark:text-neutral-500";
// const BODY_CLS = "text-neutral-900 dark:text-[#EDE8DF]";
//
// // ─── sub-components ───────────────────────────────────────────────────────────
//
// function MetaBar() {
...
//     <div className="flex items-start justify-between pb-4 mb-10 border-b border-neutral-200/10 dark:border-white/[0.06]">
//       <span
//         className={cn("text-[10px] tracking-[0.2em] uppercase", MUTED_CLS)}
//         style={{ letterSpacing: "0.18em" }}
//       >
//         02 — Connecting
//       </span>
//       <p
//         className={cn(bodyMicro, "text-right max-w-[230px]", MUTED_CLS)}
//       >
//         Detect environments, deploy controlled inputs into those spaces,
//         measure response, establish causality.
//       </p>
...
//
//             {/* Headline col — orange left rule */}
//             <MaskedReveal delay={0.1}>
//               <div
//                 className="pl-4"
//                 style={{ borderLeft: `2.5px solid ${ORANGE}` }}
//               >
//                 <span
//                   className={cn(
//                     "block mb-2 text-[10px] tracking-[0.1em] uppercase font-normal",
//                     MUTED_CLS,
//                   )}
//                 >
//                   Map audience signals across
//                 </span>
//                 <p style={headlineMobile} className={BODY_CLS}>
//                   Brands,
//                   <br />
//                   <span className={ORANGE_CLS}>Creators</span>
//                   <span
//                     className="block"
//                     style={{ color: "rgba(120,115,105,0.35)", fontSize: "0.6em", margin: "3px 0 1px" }}
//                   >
//                     And
//                   </span>
//                   <span className={ORANGE_CLS}>Communities.</span>
...
//
//           {/* bottom bar */}
//           <div className="mt-8 flex items-end justify-between gap-4 pt-5 border-t border-neutral-200/10 dark:border-white/[0.06]">
//             <MaskedReveal delay={0.16}>
//               <p className={cn(bodyMicro, "max-w-[240px]", MUTED_CLS)}>
//                 Reach is no longer enough. Messages are far more effective when
//                 delivered through trusted voices operating within the right
...
//             style={{ gridTemplateColumns: "1fr clamp(180px, 18vw, 220px)" }}
//           >
//             {/* Headline col — orange left rule */}
//             <MaskedReveal delay={0.1}>
//               <div
...
//                 <span
//                   className={cn(
//                     "block mb-2.5 text-[10.5px] tracking-[0.1em] uppercase font-normal",
//                     MUTED_CLS,
//                   )}
//                 >
//                   Map audience signals across
//                 </span>
//                 <p style={headlineDesktop} className={BODY_CLS}>
//                   Brands,
//                   <br />
//                   <span className={ORANGE_CLS}>Creators</span>
//                   <span
//                     className="block"
//                     style={{ color: "rgba(120,115,105,0.3)", fontSize: "0.58em", margin: "4px 0 2px" }}
//                   >
//                     And
//                   </span>
//                   <span className={ORANGE_CLS}>Communities.</span>
...
//
//           {/* bottom bar */}
//           <div className="flex items-end justify-between gap-8 pt-5 border-t border-neutral-200/10 dark:border-white/[0.06]">
//             <MaskedReveal delay={0.17}>
//               <p className={cn(bodyMicro, "max-w-[320px]", MUTED_CLS)}>
//                 Reach is no longer enough. Messages are far more effective when
//                 delivered through trusted voices operating within the right
//                 cultural, social, and emotional contexts.
//               </p>
