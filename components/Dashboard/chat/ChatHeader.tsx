...
export default function ChatHeader({
    ...
    return (
        <motion.div
            className="w-full p-3 sm:p-4 border-b bg-card/95 backdrop-blur supports-[padding:env(safe-area-inset)]:pt-[env(safe-area-inset-top)] sticky left-0 right-0 top-0 z-10"
        >
