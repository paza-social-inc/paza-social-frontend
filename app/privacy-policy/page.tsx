    ...
    <div className="min-h-dvh bg-background text-foreground">
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-8 sm:py-10">
        ...
        <p className="text-sm text-muted-foreground mb-8">
          Last updated: June 21, 2026 · Jurisdiction: Republic of Kenya
        </p>
        ...
        <article className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
          <section>
            ...
            <p className="text-muted-foreground text-sm">Email: <a href="mailto:privacy@paza.ai" className="text-primary hover:underline">privacy@paza.ai</a><br />Nairobi, Kenya</p>
          </section>
