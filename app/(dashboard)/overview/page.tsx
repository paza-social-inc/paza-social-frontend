...
export default function OverviewPage() {
  ...
  const stats = {
    ...
    totalProposals: jobs.reduce(
      (acc, job) => acc + (job.proposals?.length || 0),
      0,
    ),
  ...
  const totalEarnings = escrowStats
    ? Math.max(0, escrowStats.totalEarnedKobo / 100)
    : 0;
  ...
  const recentTransactions: Transaction[] = escrows
    ...
    .map((e) => {
      ...
      const amount = isCredit
        ? (e.sellerAmountKES ?? e.totalAmountKES ?? 0)
        : (e.totalAmountKES ?? 0);
      return {
        id: String(e.id),
  ...
  const latestTaskRow = [...tasks].sort(
  ...
  return (
    <div className="w-full min-w-0 space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold dark:text-white text-foreground tracking-wider">
            Overview
          </h1>
          <p className="text-sm dark:text-neutral-400 text-foreground">
            Track your earnings, campaign performance, and activity at a glance.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <Card className="dark:bg-neutral-900 bg-card dark:border-neutral-700 border flex-1">
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs dark:text-neutral-400 text-foreground tracking-wider">
                    TOTAL EARNINGS
                  </p>
            ...
            <CardFooter className="pt-0 px-4 pb-4">
              <div className="flex w-full items-center justify-between text-xs">
                <span className="dark:text-neutral-400 text-foreground/80">
                  This month
                </span>
          ...
          <Card className="dark:bg-neutral-900 bg-card border dark:border-neutral-700 flex-1">
            ...
            <CardFooter className="pt-0 px-4 pb-4">
              <div className="flex w-full items-center justify-between text-xs">
                <span className="dark:text-neutral-400 text-foreground">
                  Active
                </span>
                <span className="text-emerald-400 font-mono">
        ...
        <Card className="dark:bg-neutral-900 bg-card border dark:border-neutral-700 flex-1 flex flex-col">
          ...
          <CardContent className="flex-1">
            {(() => {
              ...
              const chartData = [
                { key: "progress", value: c.percent, fill: c.fill },
              ];
              ...
              {recentTransactions.length === 0 ? (
                ...
                recentTransactions.map((tx) => (
                  ...
                  >
                    ...
                    <div
                      className={`text-sm font-mono ${tx.type === "credit" ? "text-emerald-400" : "text-rose-400"}`}
                    >
                      {tx.type === "credit" ? "+" : "-"}$
